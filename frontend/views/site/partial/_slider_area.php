...
<div class="main-wrapper">
    ...
    <div class="notification-section bg-theme-color section-padding-1">
        <div class="container-fluid">
    ...
    <div class="slider-area">
        <div class="container-fluid p-0">
            <div class="main-slider-active owl-carousel slider-dot-position-2 slider-dot-style-1 slider-img-width-hm3">
                <div class="single-main-slider slider-animated-1 bg-img slider-height-hm3 align-items-center custom-d-flex res-white-overly-xs" data-dot="01" style="background-image:url(assets/images/slider/slider-hm3-1.jpg);">
                ...
                <div class="single-main-slider slider-animated-1 bg-img slider-height-hm3 align-items-center custom-d-flex" data-dot="02" style="background-image:url(assets/images/slider/slider-hm3-2.jpg);">
                    <div class="row g-0 width-100-percent">
                ...
                <div class="single-main-slider slider-animated-1 bg-img slider-height-hm3 align-items-center custom-d-flex " data-dot="03" style="background-image:url(assets/images/slider/slider-hm3-3.jpg);">
                    <div class="row g-0 width-100-percent">
    ...
    <div class="banner-area">
        <div class="banner-top banner-wrap">
            <div class="jarallax parallax-img parallax-ptb-1" style="background-image: url(assets/images/bg/bg-2.jpg);">
                <div class="row g-0">
                    <div class="col-12">
                        <div class="banner-content-1 text-center">
                            <span>#New Fashion Week 2020</span>
                            <h2>London Show</h2>
                            <div class="btn-style-1 text-center">
                                <a href="product-details.html">
        ...
        <div class="banner-bottom">
            <div class="row g-0">
                <div class="col-lg-6 col-md-6">
                    <div class="banner-wrap default-overlay banner-zoom res-white-overly-xs">
                        ...
                        <div class="banner-content-2 banner-position-1">
                            <span>#Jumpsuit</span>
                            <h3><a href="#">Checked Knit Jumpsui</a></h3>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="banner-wrap default-overlay banner-zoom res-white-overly-xs">
                        ...
                        <div class="banner-content-2 banner-position-2">
                            <span>#Shoes</span>
                            <h3><a href="#">Suede panels leather sneakers</a></h3>
                            <div class="btn-style-1">
                                <a href="product-details.html">
                                    <div class="btn-viewmore-normal btn-ptb-2 btn-viewmore-bg-black btn-viewmore-common btn-font-2">
                                        <span>SHOP NOW</span>
    ...
    <div class="delay-area pt-130">
        <div class="container">
            <div class="section-title-2 mb-70 text-center">
                <h2>Deal of day</h2>
            </div>
        </div>
        <div class="jarallax parallax-img parallax-ptb-2 res-white-overly-md res-white-overly-xs" style="background-image: url(assets/images/bg/bg-3.jpg);">
            <div class="row g-0">
                <div class="col-xl-6 col-lg-5 ms-auto">
                    <div class="delay-content-2 text-center">
                        <span>Flash Sale This Week</span>
                        <h3>VELVET FROCK COAT</h3>
                        <h2>Off 30%</h2>
                        <div class="delay-price">
    ...
    <div class="subscribe-area pt-125 pb-130">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 ms-auto me-auto">
                    <div class="section-title-2 mb-60 text-center">
        ...
        <div class="container-fluid">
            <div class="footer-top pt-100 pb-35">
                <div class="row">
                    ...
                    <div class="footer-column footer-width-25 mb-30">
                        <div class="instagram-feed-thumb">
                            <div id="instafeed" data-limit="6" class="instagram-wrap-2"></div>
                        </div>
                    </div>
                </div>
            </div>
