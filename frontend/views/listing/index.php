                    ...
                    <div class="shop-top-bar">
                        <div class="shop-top-bar-right text-left">
                            <div class="shop-filter ml-50">
                                <a class="shop-filter-active btn btn-dark text-white" href="#">Filters <i class="fa fa-angle-down angle-down"></i> <i class="fa fa-angle-up angle-up"></i></a>
                            </div>
                            <div class="shop-short-by ml-50">
                                <span class="btn btn-dark text-white">Sort by <i class="fa fa-angle-down angle-down"></i> <i class="fa fa-angle-up angle-up"></i></span>
                                <ul>
